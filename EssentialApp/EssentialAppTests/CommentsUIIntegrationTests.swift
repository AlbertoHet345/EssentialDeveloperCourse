...
final class CommentsUIIntegrationTests: FeedUIIntegrationTests {
    ...
    func test_loadCommentsActions_reqiestFeedFromLoader() {
        ...
        sut.simulateUserInitiatedReload()
        XCTAssertEqual(loader.loadCommentsCallCount, 3, "Expected a thir loading request once user initiatiates another load")
    }
    ...
    override func test_loadFeedCompletion_rendersErrorMessageOnErrorUntilNectReload() {
        let (sut, loader) = makeSUT()
