...
//  EssentialApp
//
//  Created by Alberto Garcia Paul on 16/02/24.
//
...
extension DispatchQueue {
    ...
    static var inmediateWhenOnMainThreadScheduler: InmediateWhenOnMainThreadScheduler {
        InmediateWhenOnMainThreadScheduler()
    }
    
    struct InmediateWhenOnMainThreadScheduler: Scheduler {
        typealias SchedulerTimeType = DispatchQueue.SchedulerTimeType
        typealias SchedulerOptions = DispatchQueue.SchedulerOptions
...
extension AnyDispatchQueueScheduler {
    static var inmediateOnMainQueue: Self {
        DispatchQueue.inmediateWhenOnMainQueueScheduler.eraseToAnyScheduler()
    }
}
